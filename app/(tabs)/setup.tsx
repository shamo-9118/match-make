...
import { GameFormat, User } from '../../src/types';
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.label}>
        ...
        {!canStart && (
          <Text style={styles.warn}> （最低{minRequired}人必要）</Text>
        )}
      </Text>
      <FlatList
        data={sortedUsers}
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.countText}>{item.totalPlayCount}試合</Text>
